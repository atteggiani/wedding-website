...
<div class="section" id="travel">
  ...
  <div class="subsection">
    ...
    <p>
        Si vienes del extranjero, te recomendamos llegar al <strong>Aeropuerto de Roma Fiumicino (FCO)</strong>.
    </p>
    <p>
        Una vez en Roma, dirígete a la estación de tren <strong>Roma Termini</strong>.
    </p>
    <p>
...
<div class="section" id="stay">
    <h2 class="section-title">Dónde alojarse</h2>
    <div class="subsection">
        <h3 class="subsection-title">
