...
---
<h5>Tutto quello che dovete sapere per pianificare il vostro viaggio!</h5>
<div class="section" id="travel">
  ...
  <div class="subsection">
    ...
    <p>
        Se venite dall'estero, vi consigliamo di arrivare all'<strong>Aeroporto di Roma Fiumicino (FCO)</strong>.
    </p>
    <p>
        Una volta a Roma, andate alla stazione dei treni di <strong>Roma Termini</strong>.
    </p>
    <p>
...
<div class="section" id="stay">
    ...
    <div class="subsection">
        ...
        <p>
            Poiché i festeggiamenti termineranno indicativamente <strong>tra mezzanotte e le 02:00 di giovedì 3 settembre 2026</strong>, la notte del matrimonio consigliamo di pernottare <strong>nei pressi di Torre Ubaldo</strong>, per un rientro comodo e senza stress.
        </p>
        <p>
